export const DATA = {
  ...
  description:
    "Full Stack Developer & Software Engineer — Enterprise LMS, SMS, ERP & AI Tooling",
  summary:
    "Full Stack Developer with 4+ years of software engineering experience and 2+ years of professional experience building enterprise LMS, SMS, ERP, and web systems. Specialized in Next.js, NestJS, Vue 3, and Frappe Framework, with deep expertise in custom Model Context Protocol (MCP) servers, RAG integrations, and type-safe data architectures.",
  ...
  navbar: [
    ...
    { href: "#stack", icon: "Cpu", label: "Architecture" },
    { href: "#skills", icon: "Brain", label: "Skills" },
  ],
  mindset: [
    {
      title: "Type Safety & Data Integrity",
      description:
        "Building reliable database schemas with Drizzle ORM across MySQL and PostgreSQL, keeping queries fast and types consistent end-to-end.",
      icon: "Shield",
    },
    {
      title: "Custom MCP & AI Tooling",
      description:
        "Developing custom Model Context Protocol (MCP) servers and permissioned RAG pipelines to connect internal tools with modern AI workflows.",
      icon: "Zap",
    },
    {
      title: "Scalable Institutional Systems",
      description:
        "Engineering multi-tenant LMS, SMS, and ERP platforms using NestJS and Frappe Framework v15 for real-world school and business operations.",
      icon: "Users",
    },
  ],
  stackSteps: [
    ...
    },
    {
      ...
      title: "Data & AI Layer",
      icon: "🗄️",
      description: "Postgres/MySQL • Drizzle ORM • Custom MCP",
      tag: "Persistence Layer",
    },
  ],
  valueMetrics: [
    { label: "Engineering Practice", value: "4+ Yrs" },
    { label: "Primary Stack", value: "Next.js / Frappe" },
    { label: "Specialization", value: "Full Stack & MCP" },
  ],
  contact: {
